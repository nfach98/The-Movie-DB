...
interface ApiServices {
    ...
    @GET("movie/now_playing?api_key=${BuildConfig.API_KEY}&page=1")
    fun getNowPlayingMovies(@Query("region") region: String): Call<MovieResponse>

    @GET("movie/popular?api_key=${BuildConfig.API_KEY}&page=1")
    fun getPopularMovies(@Query("region") region: String): Call<MovieResponse>

    @GET("movie/top_rated?api_key=${BuildConfig.API_KEY}&page=1")
    fun getTopRatedMovies(@Query("region") region: String): Call<MovieResponse>

    @GET("movie/upcoming?api_key=${BuildConfig.API_KEY}&page=1")
    fun getUpcomingMovies(@Query("region") region: String): Call<MovieResponse>


    @GET("tv/airing_today?api_key=${BuildConfig.API_KEY}&page=1")
    fun getAiringTodayTV(): Call<TVShowResponse>

    @GET("tv/popular?api_key=${BuildConfig.API_KEY}&page=1")
    fun getPopularTV(): Call<TVShowResponse>

    @GET("tv/on_the_air?api_key=${BuildConfig.API_KEY}&page=1")
    fun getOnTheAirTV(): Call<TVShowResponse>

    @GET("tv/top_rated?api_key=${BuildConfig.API_KEY}&page=1")
    fun getTopRatedTV(): Call<TVShowResponse>


    @GET("discover/movie?api_key=${BuildConfig.API_KEY}&page=1")
    ...
    @GET("discover/tv?api_key=${BuildConfig.API_KEY}&page=1")
    ...
    @GET("tv/{id}/credits?api_key=${BuildConfig.API_KEY}")
